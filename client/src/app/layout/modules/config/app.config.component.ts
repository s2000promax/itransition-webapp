...
export class AppConfigComponent implements OnInit {
    ...
    private initializeThemesItems(): void {
        this.themesItems = [
            { themeStyle: ThemeStyles.LIGHT_INDIGO, colorStyle: ColorStyles.LIGHT, src: 'lara-light-indigo.png' },
            { themeStyle: ThemeStyles.LIGHT_BLUE, colorStyle: ColorStyles.LIGHT, src: 'lara-light-blue.png' },
            { themeStyle: ThemeStyles.LIGHT_PURPLE, colorStyle: ColorStyles.LIGHT, src: 'lara-light-purple.png' },
            { themeStyle: ThemeStyles.LIGHT_TEAL, colorStyle: ColorStyles.LIGHT, src: 'lara-light-teal.png' },
            { themeStyle: ThemeStyles.DARK_INDIGO, colorStyle: ColorStyles.DARK, src: 'lara-dark-indigo.png' },
            { themeStyle: ThemeStyles.DARK_BLUE, colorStyle: ColorStyles.DARK, src: 'lara-dark-blue.png' },
            { themeStyle: ThemeStyles.DARK_PURPLE, colorStyle: ColorStyles.DARK, src: 'lara-dark-purple.png' },
            { themeStyle: ThemeStyles.DARK_TEAL, colorStyle: ColorStyles.DARK, src: 'lara-dark-teal.png' },
        ];
    }
